...
class AlignerDataset(Dataset):
    def __init__(
        ...
        if (
            ...
            if cut_silences:
                ...
                torch.hub.load(
                    ...
                    onnx=False,
                    verbose=False,
                )  # download and cache for it to be loaded and used later
        ...
        print(
            f"Prepared an Aligner dataset with {len(self.datapoints)} datapoints in {cache_dir}."
        )
