...
from src.spk_embedding.GST import StyleEncoder
...
if __name__ == "__main__":
    ...
    print(
        f"GST parameter count: {sum(p.numel() for p in style_emb.gst.parameters() if p.requires_grad)}"
    )

    seq_length = 398
    print(
        style_emb(
            torch.randn(5, seq_length, 80),
